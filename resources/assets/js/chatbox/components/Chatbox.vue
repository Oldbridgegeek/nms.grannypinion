	...
	<div>
		<div class="chat_window">
			<div class="top_menu">
				...
				<div class="title">
					{{additionalInfo.chatWith}} {{chatWithAnonymous() ? additionalInfo.anonymousUser : pal.fullName }}
				</div>
			</div>
			<ul class="messages">
				<li :class="['message', 'appeared', isCurrentUser(message) ? 'left' : 'right']" v-for="(message, index) in messages">
					<div class="avatar">
...
<script>
	...
	export default
	{
		...
		methods: {
		    ...
		    currentUserImage: function(message)
		    {
		    	return this.currentUser.id == message.user.id;
		    },
